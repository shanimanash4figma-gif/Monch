import svgPaths from "./svg-46vg81abkh";
    ...
    <div className="absolute inset-[10.21%_14.31%_17.51%_13.4%]" data-name="Group">
      <div className="absolute inset-[-6.92%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.1573 13.1573">
          <g id="Group">
            <path d={svgPaths.p2631d280} id="Vector" stroke="var(--stroke-0, #0C3058)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.59896" />
            <path d={svgPaths.p17499200} id="Vector_2" stroke="var(--stroke-0, #0C3058)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.59896" />
          </g>
        </svg>
      </div>
    </div>
...
function Container7() {
  return (
    <div className="bg-white relative rounded-[16px] shadow-[0px_4px_12px_0px_rgba(6,77,173,0.15)] shrink-0 w-[912.986px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pl-[47.986px] pt-[31.997px] relative w-full">
        <ResultsStep />
      </div>
    </div>
  );
