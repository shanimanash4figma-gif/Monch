import svgPaths from "./svg-dexyy3n1n7";
...
function Paragraph1() {
  return (
    <div className="h-[23.25px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute css-ew64yg font-['Inter:Regular','Arimo:Regular',sans-serif] font-normal leading-[23.25px] left-[346px] not-italic text-[#4b5563] text-[15px] top-[-0.25px] tracking-[-0.2344px]" dir="auto">
        יכול להיות שתוכל לחסוך את הגשת הפניה בעזרת המידע הבא:
      </p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col h-[55.917px] items-start pb-[0.667px] pt-[16px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-b-[0.667px] border-solid inset-0 pointer-events-none" />
      <Paragraph1 />
    </div>
  );
